...
const AddBlog = () => {
  ...
  return (
    <div className="min-h-screen mx-3 lg:mx-0 flex items-center justify-center bg-cover bg-center my-6">
      <div className="bg-white/20 backdrop-blur-md p-8 rounded-lg w-full max-w-2xl border border-gray-200">
